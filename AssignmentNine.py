"""
This program extends Assignment Eight and builds a Location and Property
type filter.
"""
...
Enter a header for the menu: AirBNB Data Project
...
Manhattan removed from active_labels
The following labels are in the dataset: 
1: Manhattan            INACTIVE
2: Queens               ACTIVE
3: Brooklyn             ACTIVE
4: Staten Island        ACTIVE
5: Bronx                ACTIVE
Please select an item to toggle or enter a blank line when you are finished: 2
Queens removed from active_labels
The following labels are in the dataset: 
1: Manhattan            INACTIVE
2: Queens               INACTIVE
3: Brooklyn             ACTIVE
...
5: Bronx                ACTIVE
Please select an item to toggle or enter a blank line when you are finished: 1
Manhattan added to active_labels
The following labels are in the dataset: 
1: Manhattan            ACTIVE
2: Queens               INACTIVE
3: Brooklyn             ACTIVE
...
2: Entire home/apt      INACTIVE
Please select an item to toggle or enter a blank line when you are finished: 2
Entire home/apt added to active_labels
The following labels are in the dataset: 
1: Private room         ACTIVE
2: Entire home/apt      ACTIVE
Please select an item to toggle or enter a blank line when you are finished: 1
