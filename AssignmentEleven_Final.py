"""
This program extends Assignment Ten and incorporates file I/O with
the csv package to read data from a csv file
"""
...
class DataSet:
    ...
    def load_file(self):
        ...
        for row in csvreader:
            data = (row[1], row[2], int(row[3]))
            dataset.append(data)
        
        print(f"{len(dataset)} lines are loaded")
...
9 - Quit
What is your choice? 1
Locations           Entire home/apt     Private room        Shared room         
